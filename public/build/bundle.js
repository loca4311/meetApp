...
var app = (function () {
    ...
    const meetups = writable([
      {
        ...
        address: "27th Chornovola, 32523 Lviv",
      ...
      },
      {
        id: "m2",
        title: "Code Together",
        subtitle: "Let's go for some coding",
        description: "We will simply code some!",
        imageUrl:
          "https://media.istockphoto.com/id/1354441996/photo/image-of-open-antique-book-on-wooden-table-with-glitter-overlay.jpg?b=1&s=170667a&w=0&k=20&c=O_VZbgONe4WTXPOEvwKYezhqFkzAXpr2g-lCdpdj5FU=",
        address: "27th Chornovola, 32523 Lviv",
    ...
    // (45:4) <Button mode="outline" on:click={() => dispatch("edit", id)}>
    function create_default_slot_2$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(45:4) <Button mode=\\\"outline\\\" on:click={() => dispatch(\\\"edit\\\", id)}>",
    		ctx
    	});
    ...
    // (52:4) <Button on:click={() => dispatch("showDetails", id)}>
    function create_default_slot$4(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(52:4) <Button on:click={() => dispatch(\\\"showDetails\\\", id)}>",
    		ctx
    	});
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$7, 26, 4, 508);
    			attr_dev(h2, "class", "svelte-enhpap");
    			add_location(h2, file$7, 32, 4, 603);
    			attr_dev(p0, "class", "svelte-enhpap");
    			add_location(p0, file$7, 33, 4, 627);
    			attr_dev(header, "class", "svelte-enhpap");
    			add_location(header, file$7, 25, 2, 495);
    			...
    			add_location(img, file$7, 36, 4, 682);
    			attr_dev(div0, "class", "image svelte-enhpap");
    			add_location(div0, file$7, 35, 2, 658);
    			attr_dev(p1, "class", "svelte-enhpap");
    			add_location(p1, file$7, 39, 4, 754);
    			attr_dev(div1, "class", "content svelte-enhpap");
    			add_location(div1, file$7, 38, 2, 728);
    			attr_dev(footer, "class", "svelte-enhpap");
    			add_location(footer, file$7, 43, 2, 798);
    			attr_dev(article, "class", "svelte-enhpap");
    			add_location(article, file$7, 24, 0, 483);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$4, 25, 4, 527);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_1$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(textarea, file$4, 17, 4, 376);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$4, 35, 4, 730);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_default_slot_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(form, file$2, 85, 2, 1832);
    		},
    		m: function mount(target, anchor) {
    ...
    // (150:6) <Button type="button" on:click={deleteMeetup}>
    function create_default_slot$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(150:6) <Button type=\\\"button\\\" on:click={deleteMeetup}>",
    		ctx
    	});
    ...
    function create_footer_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 143, 2, 3387);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.update = () => {
    		...
    		if ($$self.$$.dirty & /*titleValid, emailValid, subtitleValid, addressValid, descriptionValid, imageUrlValid*/ 8064) {
    			$$invalidate(13, formIsValid = titleValid && emailValid && subtitleValid && addressValid && descriptionValid && imageUrlValid);
    		}
    	};
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file, 43, 0, 853);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
